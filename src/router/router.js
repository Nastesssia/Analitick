...
import PersonalDataConsentPage from '../pages/PersonalDataConsentPage.vue';

const HomeStub = { template: '<div></div>' };
...
const routes = [
  ...
  { path: '/personal-data-consent', component: PersonalDataConsentPage },
